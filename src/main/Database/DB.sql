...
(nextval('buses_seq'), 3, 1, 19, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 3, 6, 18, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 4, 10 ,18, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 4, 3, 14, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 5, 8, 19, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 5, 6, 22, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 2, 1, 42, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 6, 9, 17, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 9, 1, 37, '2019-05-06', '2019-05-06', 30),

(nextval('buses_seq'), 7, 9, 10, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 8, 10, 13, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 6, 8, 21, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 1, 12, 44, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 12, 22, 59, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 2, 25, 6, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 25, 2, 6, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 25, 19, 57, '2019-05-01', '2019-05-02', 30),

(nextval('buses_seq'), 19, 1, 69, '2019-05-10', '2019-05-11', 30);
